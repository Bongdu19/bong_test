...
function renderComparisonTable(rows) {
  ...
  categoryOrder.forEach(function (catName) {
    ...
    html += '<th class="col-item" style="width: 14%;"><i class="bi bi-card-checklist"></i> 검토 항목</th>';
    html += '<th class="col-result" style="width: 8%;"><i class="bi bi-shield-check"></i> 결과</th>';
    html += '<th class="col-doc col-lc" style="width: 13%;"><i class="bi bi-file-earmark-text"></i> L/C</th>';
    html += '<th class="col-doc col-inv" style="width: 13%;"><i class="bi bi-receipt"></i> 송장</th>';
    html += '<th class="col-doc col-bl" style="width: 13%;"><i class="bi bi-water"></i> B/L</th>';
    html += '<th class="col-doc col-pk" style="width: 13%;"><i class="bi bi-box-seam"></i> 포장</th>';
    html += '<th class="col-doc col-ins" style="width: 13%;"><i class="bi bi-shield-check"></i> 보험</th>';
    html += '<th class="col-doc col-coo" style="width: 13%;"><i class="bi bi-bank"></i> COO</th>';
    html += '</tr>';
    html += '</thead>';
    html += '<tbody>';
