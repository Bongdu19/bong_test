...
| Parameter  | Type   | Required | Description                                                    |
|------------|--------|----------|----------------------------------------------------------------|
| model      | string | Yes      | Agent ID: `agt_EpTRLGpvzaoGjJEEyPcWN8`    |
| config_id  | string | No       | Config version ID. Omit to use latest.          |
...
client = OpenAI(
    api_key="YOUR_API_KEY",        # or os.environ["UPSTAGE_API_KEY"]
...
job = client.responses.create(
    model="agt_EpTRLGpvzaoGjJEEyPcWN8",  # Agent ID
...
- Agent ID: `agt_EpTRLGpvzaoGjJEEyPcWN8`
...
- These instructions: [https://ip-100-200-5-79.us-west-2.compute.internal:3000/agents/agt_EpTRLGpvzaoGjJEEyPcWN8/code.md](https://ip-100-200-5-79.us-west-2.compute.internal:3000/agents/agt_EpTRLGpvzaoGjJEEyPcWN8/code.md)